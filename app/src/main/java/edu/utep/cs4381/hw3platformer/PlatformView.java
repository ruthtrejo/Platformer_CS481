...
import edu.utep.cs4381.hw3platformer.model.Location;
import edu.utep.cs4381.hw3platformer.model.PlayerState;
import edu.utep.cs4381.hw3platformer.model.RectHitbox;
...
public class PlatformView extends SurfaceView implements Runnable {
    ...
    PlatformView(Context context, int screenWidth, int screenHeight) {
        ...
        //loadLevel("LevelWaterTribe",1, 15);
    ...
    private void draw() {
        ...
        if (ourHolder.getSurface().isValid()) {
            ...
            canvas.drawText("Ruth Trejo and Jose Soto", 400, 200, paint);
